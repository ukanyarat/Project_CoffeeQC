...
type Input = { company_id: string; start_date?: string; end_date?: string; limit?: number };

export async function getTopMenus({ company_id, start_date, end_date, limit = 5 }: Input) {
