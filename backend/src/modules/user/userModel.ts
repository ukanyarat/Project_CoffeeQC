...
export const CreateUserSchema = z.object({
    body: z.object({
        ...
        emp_start_date: z.string().max(10, "emp_start_date must be less than 10 characters").nullable().optional(),
        emp_status: z.string().max(20, "emp_status must be less than 20 characters").nullable().optional(),
